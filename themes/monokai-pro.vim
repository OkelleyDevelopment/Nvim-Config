...
let s:configuration.transparent_background = get(g:, 'monokai-pro_transparent_background', 0)
let s:configuration.disable_italic_comment = get(g:, 'monokai-pro_disable_italic_comment', 0)
